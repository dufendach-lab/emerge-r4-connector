...
record_ids = pandas.read_csv("/Volumes/Emerge_R4/20-OCT-2022/ProwseMERGEIVGenomic-ParticipantsInfoReco_DATA_LABELS_2022-10-20_1315 (1).csv")
...
general_info = pandas.read_csv("/Volumes/Emerge_R4/20-OCT-2022/2022Oct_Demo.csv")
...
general_info_import = general_info_import.drop('participant_lab_id', axis=1)
...
ICD_flags = pandas.read_csv("/Volumes/Emerge_R4/20-OCT-2022/2022Oct_ICD_flag_first dx_3yr.csv")
...
allergy_labs = pandas.read_csv("/Volumes/Emerge_R4/20-OCT-2022/2022Oct_Labs_Allergy.csv")
...
numerical_labs = pandas.read_csv("/Volumes/Emerge_R4/20-OCT-2022/2022Oct_Labs_Numerical.csv")
